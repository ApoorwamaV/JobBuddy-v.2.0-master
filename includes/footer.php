                    ...
                    <section class="col-12 col-sm-12 col-md-12"> 
                        <div class="form-row col-12 col-md-12 col-sm-12 justify-content-start bg-dark">  
                            <div class="form-group col-md-2 justify-content-center"> <a href="#"><br><br>
                                <img src="Images/location.png" alt="Location" width="50" height="50"> <p class="justify-content-center" style="color:white; font-family:Times New Roman; font-size: 16px;">Kalagedihena, <br>Nittambuwa,<br>Sri Lanka.</p></a>
                            </div>
                            <div class="form-group col-md-2 justify-content-center"> <a href="#"><br><br>
                                <img src="Images/call.png" alt="Contact Number" width="50" height="50"> <p class="justify-content-center" style="color:white; font-family:Times New Roman; -size: 16px;">+94 70 588 2716</p></a>
                            </div>
                            <div class="form-group col-md-2 justify-content-center"> <a href="https://www.facebook.com/106660131113039?referrer=whatsapp"><br><br>
                                <img src="Images/facebook.png" alt="Facebook" width="50" height="50"> <p class="justify-content-center" style="color:white; font-family:Times New Roman; font-size: 16px;">JOBBuddy Career</p></a>
                            </div>
                            <div class="form-group col-md-2 justify-content-center"><a href="mailto:jobbuddycareer@gmail.com"><br><br>
                                <img src="Images/gmail.png" alt="Gmail"  width="50" height="50"> <p class="justify-content-center" style="color:white; font-family:Times New Roman; font-size: 16px;">jobbuddycareer@gmail.com</p></a>
                            </div>
                            <div class="form-group col-md-2 justify-content-center"> <a href="#"><br><br>
                                <img src="Images/whatsapp.png" alt="Whatsapp" width="50" height="50"> <p class="justify-content-center" style="color:white; font-family:Times New Roman; font-size: 16px;">+94 70 588 2716</p></a>
                            </div>
                            <div class="form-group col-md-2 justify-content-center"> <a href="https://www.youtube.com/channel/UCzh1By4MZccb8SsgAlvyFSA"><br><br>
                                <img src="Images/youtube.png" alt="Youtube" width="50" height="50"> <p class="justify-content-center" style="color:white; font-family:Times New Roman; font-size: 16px;">JOBBuddy Career</p></a>
                            </div>
                        </div>
                </section></section>
    </div>
