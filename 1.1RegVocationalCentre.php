...
<section class="container-fluid">
    ...
    <form class="form-container justify-content-center col-12 col-sm-6 col-md-10 "  method="post" action="Reg_VC.php" enctype="multipart/form-data">
    <form class="stuReg">
<!-------------------------------------Row 01------------------------------------------------>
<!--Centre Name-->
    <div class="form-group col-12 col-md-12 col-sm-12">
      <label for="vtcName">Vocational Training Centre</label>
      <input type="text" class="form-control" name="vtcName" id="vtcName" placeholder="Vocational Training Centre - Gampaha" required>
    </div>
<!-------------------------------------Row 02------------------------------------------------>
<!--Centre ID-->
    <div class="form-group col-12 col-md-12 col-sm-12">
      <label for="vtcRegID">Registered Number</label>
      <input type="text" class="form-control" name="vtcRegID" id="vtcRegID" placeholder="1111-222-555-888" required>
    </div>
<!--Centre District-->
...
<div class="form-row col-md-12">
  ...
  <div class="form-group col-md-6">
    ...
    <input type="text" class="form-control" id="inputContactNo" name="contact_No" placeholder="+94 7# ## ## ###">
  </div>
</div>
<!-------------------------------------Row 06------------------------------------------------>
<!--Address-->
<div class="form-group">
            <label for="inputAddress">Address</label>
              <input type="text" class="form-control" id="inputAddress" name="vtcAddress" placeholder="1234, Kandy road, Nittambuwa." required>
          </div>
...
<!--E mail-->
        <div class="form-group col-md-6">
            ...
            <input type="email" class="form-control" id="EmailVtc" name="email_VTC" placeholder="prathiba@email.com">
        </div>
<!--Password-->
        <div class="form-group col-md-6">
            <label for="PasswordVtc">Password</label>
            <input type="password" class="form-control" name="inputPasswordVtc" id="PasswordVtc" required>
        </div>
</div>
...
<div class="custom-file">
        <input type="file" class="custom-file-input" id="validatedCustomFile" name="vtc_certificate" required>
