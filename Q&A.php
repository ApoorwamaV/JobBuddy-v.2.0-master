    ...
    <div class="container col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <!-- First Blog Post -->
                <h2>
                    <a href="#"><?php $PostTitle?></a>
                </h2>
                <p class="lead">
                    by <a href="index.php"><?php $PostAuthor?></a>
                </p>
                ...
                <p><span class="glyphicon glyphicon-time"></span><?php echo $PostDate?> Posted on August 28, 2013 at 10:45 PM</p>
                <hr>
                <img class="img-responsive" src="http://placehold.it/900x300" alt="">
                <hr>
